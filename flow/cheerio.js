...
exports.id = 'cheerio';		// the component id
exports.title = 'Cheerio Component';				// the human readable block
...
exports.npm = ['cheerio'];						// npm dependencies
exports.input = true;
exports.output = 2;
